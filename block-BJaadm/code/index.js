...
console.log(peopleGrade.filter((number) => number % 2 === 0));
...
persons.filter((person) => person.sex === "M").sort((a,b) => a - b).pop();
// Find the highest grade in female
persons.filter((person) => person.sex === "F").sort((a,b) => a - b).pop();
